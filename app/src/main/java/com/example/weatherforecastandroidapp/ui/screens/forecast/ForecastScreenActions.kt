...
sealed interface ForecastScreenActions {
    data object LocationPermissionDenied : ForecastScreenActions
    data object LocationPermissionGranted : ForecastScreenActions
    ...
    data object PlaceSaved : ForecastScreenActions
